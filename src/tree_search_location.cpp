...
void planner::Tree_search_location::record(const cell_world::Model_public_state &state, const Location &prey_location, float prey_orientation, const Location &predator_location, bool is_visible) {
    PERF_SCOPE("Tree_search::record");
    belief_state.record_state(state, prey_location, prey_orientation, predator_location, is_visible);
...
planner::Tree_search_location::Tree_search_location(const planner::Static_data &data, Predator &predator):
        data(data),
        predator(predator),
        belief_state(data),
...
void planner::Tree_search_location::reset() {
    belief_state.reset();
    history.clear();
}

Move planner::Tree_search_location::get_best_move_ucb1(const Model_public_state &state, const Location &prey_location, float prey_orientation, const Location &predator_location, bool is_visible) {
